...
# Instal Drupal!
cd web;drush si --site-name="dugparty" --db-url=mysql://root:root@localhost/dugparty -y;cd ../
...
echo "\$settings['trusted_host_patterns'] = array('dugparty\.dev$',);" >> web/sites/default/settings.php
